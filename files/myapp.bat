...
echo:             [2] Open Privacy settings:Microphone
echo:             [3] Open Privacy settings:Webcam
echo:             [4] Perform basic system scan
echo:             __________________________________________________  
echo:
echo:             [9] BACK
echo:
...
if %_erl%==2 start ms-settings:privacy-microphone
if %_erl%==3 start ms-settings:privacy-webcam
if %_erl%==4 goto basicscan
if %_erl%==9 goto menu
goto moremenu
:dnssafe
netsh interface ip set dns name="Ethernet" static 88.198.70.38
